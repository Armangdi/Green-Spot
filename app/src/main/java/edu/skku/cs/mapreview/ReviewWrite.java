...
public class ReviewWrite extends AppCompatActivity implements MySimpleContract.ContractForView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new MySimplePresenter(this, new MySimpleModel(presenter, ReviewWrite.this));
